...
import project.gamepage.data.model.game.spiderweb.Piece;
import project.gamepage.data.model.game.spiderweb.Pieces;
...
public class GameService {
    ...
    @Autowired
    public GameService(InvitationService invitationService, UserService userService) {
